	...
	namespace TDM_API
{
	...
	{
		auto pluginHandle = REX::W32::GetModuleHandleA("TrueDirectionalMovement.dll");
		if (!pluginHandle) {
			return nullptr;
		}
		auto requestAPIFunction = reinterpret_cast<_RequestPluginAPI>(REX::W32::GetProcAddress(pluginHandle, "RequestPluginAPI"));
